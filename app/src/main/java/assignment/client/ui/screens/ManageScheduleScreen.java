...
public class ManageScheduleScreen
{
    ...
    private static void showSchedules(ServiceManager client, int userIdThatWillBeCrosscheckedWithDoctorId)
    {
        try
        {
            List<Schedule> schedules = client.getSchedulesByDoctor(userIdThatWillBeCrosscheckedWithDoctorId);
            ...
            {
                System.out.println("ID: [" + schedule.getScheduleId() + "] | " + schedule.getDay() + " | "
    ...
    private static void addNewSchedule(ServiceManager client, int userIdToBeLaterConvertedToDoctorID)
    {
        ...
        {
            System.out.println("Invalid day! Please enter a valid day of the week (e.g., Monday, Tuesday).");
            return;
        }
        ...
        try
        {
            ...
            Schedule schedule = new Schedule(0, userIdToBeLaterConvertedToDoctorID, standardizedDay, startTime, endTime);
    ...
    private static void removeSchedule(ServiceManager client, int userIdThatWillBeCrosscheckedWithDoctorId)
    {
